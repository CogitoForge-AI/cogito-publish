...
The single most important property of Cogito Publish is this invariant:
...
building the same inputs twice produces byte-identical output. Cogito Publish enforces this
...
incremental?" case. Cogito Publish handles it without any special-casing in the `nav`
plugin:
