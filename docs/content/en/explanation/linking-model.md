...
Cogito Publish treats links as first-class data, not just text in the output. That is what
...
Because every resolved link is stored as a reverse edge in the graph, Cogito Publish can
