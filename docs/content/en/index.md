...
> This documentation site is itself built with Cogito Publish. The **References** section
...
- **[Explanation](explanation/index.md)** - understanding-oriented discussion of
  *why* Cogito Publish works the way it does (architecture, the plugin pipeline,
