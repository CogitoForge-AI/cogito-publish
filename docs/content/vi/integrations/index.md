...
Các tích hợp kết nối Cogito Publish với những công cụ bạn đang dùng để viết. Mỗi tích hợp
là một **adapter** chính thức - một lớp mỏng điều khiển quá trình build của Cogito Publish
