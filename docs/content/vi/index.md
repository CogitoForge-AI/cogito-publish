...
**Cogito Publish** là một trình tạo trang tĩnh (static site generator) nhanh, hỗ trợ build
...
> Chính trang tài liệu này cũng được build bằng Cogito Publish. Mục **References** trong
...
- **[Diễn giải (Explanation)](explanation/index.md)** - định hướng hiểu sâu, bàn
  về *vì sao* Cogito Publish hoạt động như vậy (kiến trúc, pipeline plugin, build tăng
