...
Cogito Publish is pre-1.0. Security fixes are applied to the latest `main` and released as
...
[Report a vulnerability](https://github.com/CogitoForge-AI/cogito-publish/security/advisories/new).
...
Cogito Publish is a build-time static site generator: it reads local content and templates
